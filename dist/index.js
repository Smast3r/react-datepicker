...
var St = {
    ...
    P: function (e, t) {
      ...
      return r.replace("{{date}}", bt(n, t)).replace("{{time}}", Ct(o, t));
    },
  },
  _t = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g;
function Mt(e) {
...
function Pt(e, t, r, a, n) {
  ...
  return Array.isArray(t)
    ? (t.forEach(function (t) {
        ...
        a && (i = Nt(p, n) && e === Et(p, t, r)), Nt(p, n) && i && (o = p);
      }),
      o)
...
function xt(e, t) {
  var r = t.dateFormat,
    a = t.locale;
  return (e && Et(e, Array.isArray(r) ? r[0] : r, a)) || "";
}
function Yt(e, t) {
  var r = t.hour,
    a = void 0 === r ? 0 : r,
    ...
    s = t.second,
    i = void 0 === s ? 0 : s;
  return Ye.default(xe.default(Ee.default(e, i), o), a);
}
function Ot(e, t) {
...
function $t(e, t) {
  return Et(Oe.default(Mt(), e), "LLLL", t);
}
function zt(e, t) {
  return Et(Oe.default(Mt(), e), "LLL", t);
}
function Gt(e, t) {
  return Et(Ie.default(Mt(), e), "QQQ", t);
}
function Jt(e) {
          ...
          return a.state.monthYearsList.map(function (e) {
            ...
            return ne.default.createElement(
              ...
              r
                ...
                : "",
              Et(e, a.props.dateFormat, a.props.locale)
            );
          });
        }),
  ...
  Nr = (function (e) {
    ...
    function r() {
      ...
      return (
          ...
          for (
            ...
            a.push(
              ne.default.createElement(
                "option",
                { key: n, value: n },
                Et(t, e.props.dateFormat, e.props.locale)
              )
            ),
              (t = fe.default(t, 1));
          }
        ...
        ut(vt(e), "renderReadView", function (t) {
          var r = Et(e.props.date, e.props.dateFormat, e.props.locale);
          return ne.default.createElement(
            "div",
            {
              key: "read",
    ...
    function r() {
      ...
      return (
        ...
        ut(vt(e), "getAriaLabel", function () {
          ...
          return "".concat(i, " ").concat(Et(r, "PPPP", e.props.locale));
        }),
    ...
    function r() {
      ...
      return (
        ...
        ut(vt(e), "getAriaLabel", function (t) {
          ...
          return "".concat(l, " ").concat(Et(p, "MMMM yyyy"));
        }),
          ...
          value: function () {
            ...
            return ne.default.createElement(
              "div",
              {
                ...
                "aria-label": "".concat(o, " ").concat(Et(a, "yyyy-MM")),
                role: "listbox",
              },
              t
                ? this.renderMonths()
      ...
      return (
        ...
        ut(vt(a), "formatWeekday", function (e, t) {
          return a.props.formatWeekDay
            ? (function (e, t, r) {
                return "function" == typeof t ? t(e, r) : Et(e, "EEEE", r);
